...
public class EditImageActivity extends BaseActivity {
    ...
    public static final String NAME = "id_name";
    ...
    public String photoPath; // 需要添加的照片路径
    public String name; // 需要添加的姓名
    public String age;  // 需要添加的年龄
    public String id;   // 需要添加的身份证id
    public String bottom_image; //模板底图
     ...
     * @param requestCode
     */
    public static void start(Activity context, final InfoModel model, String outputPath,final int requestCode) {
        ...
        it.putExtra(EditImageActivity.ID,model.getId());
        it.putExtra(EditImageActivity.AGE,model.getAge());
        it.putExtra(EditImageActivity.NAME,model.getName());
        it.putExtra(EditImageActivity.FILE_PATH, model.getImagePath());
        it.putExtra(EditImageActivity.BOTTOM_IMAGE,model.getBottom_image());
    ...
    private void getData() {
        ...
        photoPath = getIntent().getStringExtra(BOTTOM_IMAGE);
        loadImage(filePath);
        processParam();
    }
