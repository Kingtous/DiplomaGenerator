...
public class CustomKeyboardEditText extends MaterialEditText implements KeyboardView.OnKeyboardActionListener,
    ...
    private void initKeyboardView(Context context, AttributeSet attrs) {
        ...
        mKeyboardView = (KeyboardView) LayoutInflater.from(context).inflate(R.layout.kv_id, null);
        //键盘关联keyboard对象
